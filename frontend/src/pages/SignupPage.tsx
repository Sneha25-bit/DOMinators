  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl bg-white/10 backdrop-blur-lg border-white/20 shadow-2xl relative overflow-hidden">
          {/* Card Glow Effect */}
          ...
          <CardHeader className="text-center relative z-10">
            ...
            <CardDescription className="text-blue-100 text-lg">
              Create your account and start exploring the ocean depths
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="relative z-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="text-white font-medium">Choose Your Marine Character</Label>
                <Select onValueChange={(value) => setFormData((prev) => ({ ...prev, marineCharacter: value }))}>
                  <SelectTrigger className="bg-white/15 border-white/30 text-white focus:border-cyan-400 focus:ring-cyan-400/20 transition-all duration-300">
                    ...
                    {marineCharacters.map((character) => (
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-blue-300">- {character.description}</span>
                        </div>
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              >
                ...
                <span className="relative z-10">Create Account & Dive In 🌊</span>
              </Button>
            </form>
